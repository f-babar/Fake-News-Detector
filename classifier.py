...
DataPrep.test_data['label'].shape
...
def plot_PR_curve(classifier):
        precision, recall, thresholds = precision_recall_curve(DataPrep.test_data['label'], classifier)
        average_precision = average_precision_score(DataPrep.test_data['label'], classifier)
